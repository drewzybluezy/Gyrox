...
public class GameState implements State {
	...
	public Vector gyroVector = new Vector();
	...
	public void runGame() {
		...
		player.doTurn(gyroVector, timeCurrent);
	...
	public SensorEventListener gyroListener = new SensorEventListener() {
		...
		public void onSensorChanged(SensorEvent event) {
			gyroVector.point[0] = event.values[0];
			gyroVector.point[1] = event.values[1];
			gyroVector.point[2] = event.values[2];

			Log.v("X : " + (int) gyroVector.point[0] + " rad/s", "GYRO");
			Log.v("Y : " + (int) gyroVector.point[1] + " rad/s", "GYRO");
			Log.v("Z : " + (int) gyroVector.point[2] + " rad/s", "GYRO");
		}
	};
