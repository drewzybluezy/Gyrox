package com.dmurphy.gyrox.sound;
...
public class SoundManager {
	...
	/*
	 * Requests the instance if the sound manager and creates it if it does not
	 * exist
	 */
	...
	public static void playSound(int index, float speed) {
		...
		streamVolume /= mAudioManager
				.getStreamMaxVolume(AudioManager.STREAM_MUSIC);
		streamVolume *= 0.5;
		mIndexToStream[index] = mSoundPool.play(mSoundPoolMap.get(index),
	...
	public static void playSoundLoop(int index, float speed) {
		...
		streamVolume *= 0.5;
		mIndexToStream[index] = mSoundPool.play(mSoundPoolMap.get(index),
				streamVolume, streamVolume, 1, -1, speed);
	}
